...
7.7 sec delay</label>
 ...
 <bsbObject type="BSBLabel" version="2">
  ...
  <midicc>-3</midicc>
  <description/>
  <label>select Local SR then press Start, high local oversampling is required to avoid aliasing</label>
  <alignment>left</alignment>
  <valignment>top</valignment>
  <font>Arial</font>
  <fontsize>15</fontsize>
